...
class AccesorioTest {
	...
	void auricularHeredaDeAccesorio() {
		Auricular auricular = new Auricular(1200.00, 100);
	...
	void mostrarDetalleAccesorios() {
		...
		accesorios.add(new Joystick("Red Dragon 2020", TipoConexion.CABLE, compatibilidades, 100));
		accesorios.add(new Mouse("Red Dragon M 2020", TipoConexion.INFRARROJO, compatibilidades, 100));
		accesorios.add(new Teclado("NogaNet 500", TipoConexion.BLUETOOTH, compatibilidades, 100));
